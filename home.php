...
<div class="row" style="text-align:center;">
    <div class="column" style="text-align:center;">
        ...
        <img src="https://images.startups.co.uk/wp-content/uploads/2018/08/31104036/rsz_best_dell_laptop_2018-1.jpg" alt="laptop" style="width:90%" class="image">
    </div>
    <div class="column" style="text-align:center;">
...
<div class="row" style="text-align:center;">
    <div class="column" style="text-align:center;">
        <button type="button" data-toggle="modal" class="products" onclick="openProducts()"> Consoles </button>
